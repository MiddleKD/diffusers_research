...
def log_validation(image_encoder, movq, unet, controlnet, accelerator, weight_dtype, args):
    ...
    image_logs = []
    for val_prompt, val_image, val_cond in zip(args.val_prompts, args.val_images, args.val_conds):
        ...
        image_logs.append(
            {"images": image, "validation_prompts": val_prompt, "validation_images": val_image, "validation_control": val_cond}
        )
    ...
    for tracker in accelerator.trackers:
        if tracker.name == "wandb":
            ...
            for log in image_logs:
                ...
                formatted_images.append(wandb.Image(validation_control, caption="control_image"))
